<div id="about" class="section layout_padding">
    ...
    window.addEventListener("load", function () {
        function sendData() {
            ...
            xhr.open("POST", "<?php echo site_url('Utilisation_slot_c/affichage_slot') ?>");
            xhr.send(formData);
        }
        ...
        function handleResponse(response) {
            ...
            // Affichage des données pour le Slot A
            if (data.A && data.A.length > 0) {
                data.A.forEach(function (value) {
                    var row = "<tr><td>" + value.heure_debut + " a " + value.heure_fin + "</td></tr>";
                    document.getElementById("tableBodyA").innerHTML += row;
                });
            }

            // Affichage des données pour le Slot B
            ...
            // Affichage des données pour le Slot C
