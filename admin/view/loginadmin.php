               ...
               <div class="col-lg-3 logo_section">
                  <div class="full">
                     <div class="center-desk">
                        <div class="logo"> <a href="index.html"><img style="width:100px;" src="<?php echo base_url("assets/images/logo2.png")?>" alt="#"></a> </div>
                     </div>
                  </div>
               </div>
               <div class="col-lg-9">
                 ...
                 <div id="slider_main" class="carousel slide" data-ride="carousel">
                     ...
                     <div class="carousel-inner">
                        <div class="carousel-item active">
                           <img src="<?php echo base_url("assets/images/slider_1.png")?>" alt="#" />
                        </div>
