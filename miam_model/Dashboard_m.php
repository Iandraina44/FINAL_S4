...
class Dashboard_m extends CI_Model {
    ...
    public function getChiffreAffaire_par_voiture($id_type_voiture) {
        $this->db->select('*');
        $this->db->from('chiffre_affaire_voiture');
        $this->db->where('id_type_voiture', $id_type_voiture);
        $query = $this->db->get();
    ...
    public function get_type() {
        $query = $this->db->get('type_voiture_garage');
        return $query->result_array();
    }
